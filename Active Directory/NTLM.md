...
4. After receiving the response from the client, the server generates a hash using the stored username and password details from its database, and compares it with the response from the client. If the hashes match, the authentication is successful.
